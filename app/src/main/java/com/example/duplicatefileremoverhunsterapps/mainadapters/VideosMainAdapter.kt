...
import com.example.duplicatefileremoverhunsterapps.childadapters.VideoChildAdapter
...
class VideosMainAdapter(val list:List<FilesModel>, val context: Context, val adapterListener: MyAdapterListener) : RecyclerView.Adapter<VideosMainAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        pos++
        holder.binding.tvGroup.text= "Videos Set $pos"
        holder.binding.recyclerView.layoutManager=LinearLayoutManager(context)
        holder.binding.recyclerView.adapter= VideoChildAdapter(
