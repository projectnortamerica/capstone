...
import com.example.duplicatefileremoverhunsterapps.mainadapters.DocumentsMainAdapter
...
import com.example.duplicatefileremoverhunsterapps.databinding.ActivityDuplicateDocumentsBinding
...
class DuplicateDocumentsActivity : AppCompatActivity(), MyAdapterListener {


    lateinit var binding: ActivityDuplicateDocumentsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDuplicateDocumentsBinding.inflate(layoutInflater)
        setContentView(binding.root)
        maxInterstitialAd = MaxInterstitialAd(getString(R.string.interstitial), this)
        maxInterstitialAd!!.loadAd()
        getTotalDocumentsFiles()
        ...
        searchingDialog.setNameTitle("Scanning Documents")
    ...
    private fun getTotalDocumentsFiles() {
        val executor=Executors.newSingleThreadExecutor()
        executor.execute {
    ...
    private fun setAdapter(list: List<FilesModel>) {
        if (list.size > 0) {
            binding.recyclerView.adapter = DocumentsMainAdapter(list, this, this)
