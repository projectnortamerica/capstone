...
import com.example.duplicatefileremoverhunsterapps.mainadapters.OtherMainAdapter
...
import com.example.duplicatefileremoverhunsterapps.databinding.ActivityDuplicateOthersBinding
...
class DuplicateOthersActivity : AppCompatActivity(), MyAdapterListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchingDialog.setNameTitle("Scanning Files")
    ...
    private fun setAdapter(list: List<FilesModel>) {
        if(list.size>0){
            binding.recyclerView.adapter = OtherMainAdapter(list, this, this)
